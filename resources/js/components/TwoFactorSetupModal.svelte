    ...
    const modalConfig: TwoFactorConfigContent = $derived.by(() => {
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticación de dos factores está activada. Escanea el código QR o ingresa la clave en tu aplicación.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para activar la autenticación de dos factores, escanea el código QR o ingresa la clave en tu aplicación',
            buttonText: 'Continuar',
        };
    });
